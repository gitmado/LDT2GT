...
* \image latex locate.eps "Point location" width=5cm 
*
...
* \image latex coll.eps "Triangles are generated as soon as the first non-collinear point is inserted." width=5cm
* 
...
* \image latex crop_bareBike.eps "Delaunay triangulation without constraints" width=5cm
*
* \image html crop_ignoreBike.jpg "Figure 4: Constraint insertion with CIS_IGNORE_DELAUNAY."
* \image latex crop_ignoreBike.eps "Constraint insertion with CIS_IGNORE_DELAUNAY" width=5cm
* 
...
* \image latex crop_keepBike.eps "Constraint insertion with CIS_IGNORE_DELAUNAY" width=5cm
*
...
* \htmlonly </div> \endhtmlonly
*  
* \image latex bikeZones.eps "Zones in a triangulation" width=5cm
*/ 
	CLASS_DECLSPEC
